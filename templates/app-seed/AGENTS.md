...
4. **`ai_specs/`** — app spec workspace. Prefer `ai_specs/README.md` + `ai_specs/INDEX.md`; build specs live in `ai_specs/features/<feature>/` (`README.md` + `plan.md`). Analysis KBs: `brd/`, `design/`, `api/`.
